...
CREATE TABLE "EMPLOYEE" (
	...
	"EMP_EXTENSION"	VARCHAR2(13)		NULL,
...
VALUES('0000','admin1','admin1','Y','A','WEB','WEB',SYSDATE,'1');
-- 웹 관리자
...
INSERT INTO "PORONG"."VACATION" (VCT_NO, EDMS_CATEGORY, VCT_KIND, VCT_REASON, EMP_NO) VALUES (SEQ_VCT_NO.NEXTVAL, '1', '연차', '여행', '20231215');
-- 휴가 더미데이터
