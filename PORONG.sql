...
-- COMMENT ON COLUMN "EMPLOYEE"."EMP_ADMIN" IS 'U:일반사용자 A:관리자급';
...
CREATE TABLE "GENERAL" (
	...
	"EDMS_CATEGORY"	VARCHAR2(2)		NOT NULL,
	"GEN_TITLE"	VARCHAR2(100)		NOT NULL,
	"GEN_CONTENT"	VARCHAR2(100)		NOT NULL
...
CREATE TABLE "ATTACHMENT" (
	...
	"ORIGIN_FILENAME"	VARCHAR2(500)		NOT NULL,
	"CHANGE_FILENAME"	VARCHAR2(100)		NULL,
	"FILE_PATH"	VARCHAR2(200)		NOT NULL,
	"UPLOAD_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"REF_EMP_NO" NUMBER NOT NULL
);
...
CREATE TABLE "NOTICE_ATTACHMENT" (
	...
	"NOTICE_ORIGIN_FILENAME"	VARCHAR2(500)		NOT NULL,
	"NOTICE_CHANGE_FILENAME"	VARCHAR2(500)		NULL,
...
ALTER TABLE "GENERAL" ADD CONSTRAINT "PK_GENERAL" PRIMARY KEY (
	"GEN_NO"
);
...
CREATE SEQUENCE SEQ_GEN_NO; --일반번호
CREATE SEQUENCE SEQ_NOTICE_LIKE; --공지사항 좋아요번호


INSERT INTO EMPLOYEE (EMP_NO,EMP_NAME,EMP_PWD,EMP_STATUS,EMP_ADMIN,DEPT_CODE,JOB_CODE,CREATE_DATE,EMP_ANNUAL, FIRST_LOGIN)
VALUES('0000','admin','admin','Y','A','WEB','WEB',SYSDATE,'1', 'F');
-- 웹 관리자
INSERT INTO "PORONG"."EDMS_CATEGORY" (EDMS_CATEGORY, EDMS_NAME) VALUES ('03', '일반문서'); 
INSERT INTO "PORONG"."EDMS_CATEGORY" (EDMS_CATEGORY, EDMS_NAME) VALUES ('01', '휴가신청서');
